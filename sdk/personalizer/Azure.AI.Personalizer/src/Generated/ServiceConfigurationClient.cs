...
namespace Azure.AI.Personalizer
{
    ...
    internal partial class ServiceConfigurationClient
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly HttpPipeline _pipeline;
        internal ServiceConfigurationRestClient RestClient { get; }

        /// <summary> Initializes a new instance of ServiceConfigurationClient for mocking. </summary>
        protected ServiceConfigurationClient()
        {
        }

        /// <summary> Initializes a new instance of ServiceConfigurationClient. </summary>
        /// <param name="endpoint"> Supported Cognitive Services endpoint. </param>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <param name="options"> The options for configuring the client. </param>
        public ServiceConfigurationClient(string endpoint, AzureKeyCredential credential, PersonalizerBaseClientOptions options = null)
        {
            if (endpoint == null)
            {
        ...
        public virtual async Task<Response<PersonalizerServiceProperties>> UpdateAsync(PersonalizerServiceProperties config, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                return await RestClient.UpdateAsync(config, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Response<PersonalizerServiceProperties> Update(PersonalizerServiceProperties config, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                return RestClient.Update(config, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response> ApplyFromEvaluationAsync(PersonalizerPolicyReferenceOptions body, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="body"> The PolicyReferenceContract to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response ApplyFromEvaluation(PersonalizerPolicyReferenceOptions body, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ServiceConfigurationClient.ApplyFromEvaluation");
            scope.Start();
            try
