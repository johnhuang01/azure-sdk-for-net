...
{
    internal partial class ClientConfigurationRestClient
    {
        ...
        public async Task<Response<ClientConfiguration>> ListAsync(CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        ClientConfiguration value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = ClientConfiguration.DeserializeClientConfiguration(document.RootElement);
        ...
        /// <summary> Get configuration settings used in distributed Personalizer deployments. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<ClientConfiguration> List(CancellationToken cancellationToken = default)
        {
            using var message = CreateListRequest();
