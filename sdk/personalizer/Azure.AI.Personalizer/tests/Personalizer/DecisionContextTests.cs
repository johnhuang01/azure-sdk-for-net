...
namespace Azure.AI.Personalizer.Tests
{
    public class DecisionContextTests
    {
        ...
        public void DecisionContextConstructorTest()
        {
            ...
            Assert.AreEqual(decisionContext.Documents[0].ActionJsons.Count, 2);
            Assert.IsTrue(decisionContext.Documents[0].ActionJsons[0].Equals("{\"videoType\":\"documentary\",\"videoLength\":35,\"director\":\"CarlSagan\"}"));
            Assert.IsTrue(decisionContext.Documents[0].ActionJsons[1].Equals("{\"mostWatchedByAge\":\"30-35\"}"));
        }
    }
}
